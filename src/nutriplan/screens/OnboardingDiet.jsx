  ...
  return (
    <div className="min-h-screen bg-surface-paper relative overflow-hidden">
      ...
      <main className="flex-grow flex flex-col max-w-xl mx-auto w-full px-container-margin pb-section-padding pt-12">
        {/* Header */}
        <div className="mb-10">
          <h1 className="font-display-lg text-display-lg text-primary mb-1">How do you eat?</h1>
        ...
        <div className="flex flex-col gap-8 flex-grow">
          {/* Diet */}
          <div>
            <h3 className="font-label-lg text-label-lg text-on-surface-variant uppercase tracking-wider mb-3">Diet</h3>
            <ChipSelector
          ...
          {/* Cuisine */}
          <div>
            <h3 className="font-label-lg text-label-lg text-on-surface-variant uppercase tracking-wider mb-3">Cuisine</h3>
            <ChipSelector
          ...
          {/* Allergies */}
          <div>
            <h3 className="font-label-lg text-label-lg text-on-surface-variant uppercase tracking-wider mb-3">Allergies</h3>
            <ChipSelector
