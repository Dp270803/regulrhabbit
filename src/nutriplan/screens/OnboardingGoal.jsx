  ...
  return (
    <div className="min-h-screen bg-surface-paper relative overflow-hidden">
      ...
      <main className="flex-grow flex flex-col max-w-xl mx-auto w-full px-container-margin pb-section-padding pt-6">
        {/* Header */}
        <div className="mb-6">
          <h1 className="font-headline-md text-primary mb-0.5">NutriPlan</h1>
          <p className="font-body-md text-on-surface-variant">Eat well for your goal.</p>
        </div>

        {/* Question */}
        <h2 className="font-headline-lg text-on-surface mb-4">What's your goal?</h2>
